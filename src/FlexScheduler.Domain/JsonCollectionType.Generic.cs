namespace FlexScheduler.Domain
{
    ...
    internal class JsonCollectionType<TType> : IUserType where TType : class 
    {
        ...
        public object NullSafeGet(IDataReader rs, string[] names, object owner)
        {
            ...
            {
                return JsonConvert.DeserializeObject<IList<TType>>(val);
            }
        ...
        public object DeepCopy(object value)
        {
            ...
            return JsonConvert.DeserializeObject<IList<TType>>(serialized);
        }
